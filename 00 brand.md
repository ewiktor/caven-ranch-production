...
<!-- The single brand-binding file. Everything an agent needs to know about WHICH brand this repo is and WHERE the work stands. Filled at intake (00 intake.md), updated as rounds advance. This file is the only root doc that changes per brand — CLAUDE.md, 00 index.md, and everything in logic/ and function/ stay identical across brand repos. -->
...
[The living state line — what has happened, what is filled, what is pending whose eyes. Update this whenever a round completes or a big decision lands. Example shape: "Board pass done, 27 expression folders filled, colors near-locked pending confirm, type explicitly open, texture asset blocks judging expressions 01 and 07."]
