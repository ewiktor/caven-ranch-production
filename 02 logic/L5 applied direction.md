**Reads:** the assembled brief in 08 briefs/[concept]/ · 04 media/Media Markdown Docs/ and 05 graphics/ for CDN links · blocks/ad logic - composition.md (execution vocabulary) · L5a for the format · 00 brand.md for which build tools are in play
...
- The expression directives: the controls, keywords, terms, and phrases being controlled for — including motion and interaction behavior, spelled out in the execution vocabulary (see blocks/ad logic - composition.md)
