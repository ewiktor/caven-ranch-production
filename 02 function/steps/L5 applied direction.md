**Reads:** the assembled brief in 09 briefs/[concept]/ · 05 media/Media Markdown Docs/ and 06 graphics/ for CDN links · 01 logic/ad logic - composition.md (execution vocabulary) · L5a for the format · 00 brand.md for which build tools are in play
**Writes:** 2–3 compiled build prompts into 09 briefs/[concept]/prompts/ — tools run them, results captured per 10 output/_contract.md
...
- The expression directives: the controls, keywords, terms, and phrases being controlled for — including motion and interaction behavior, spelled out in the execution vocabulary (see 01 logic/ad logic - composition.md)
