<!-- WORKED EXAMPLE — kept in the template on purpose. This is a compiled build prompt from a real one-shot site (an unrelated brand, "prmpt"), showing the level of full specification L5 describes: structure, CDN links inline, pixel values, easing, breakpoints. It is a format reference only — its CDN links are stale and nothing in it applies to your brand. -->
