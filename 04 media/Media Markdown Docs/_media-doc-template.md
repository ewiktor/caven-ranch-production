...
[What the image shows, concretely, and what it carries: place, mood, scale, texture, proof. Written so an agent that never opens the image can place it correctly.]

## Usage

[Only if a rule binds this asset — where it may and may not appear, with the settled entry it traces to. Delete this section otherwise.]
