...
This is the human guide. Agents orient with `CLAUDE.md` and `00 index.md` instead; the step docs in `02 logic/` each carry their own Reads/Writes header.
